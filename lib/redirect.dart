...
class RedirectScreenState extends State<RedirectScreen> {
  ...
  Future<bool> getConsent(String phone) async {
    ...
    var data = '{"json": {"phone":"$phone","clientID": "pB4CscZmDKrwazY7h2pqx"}}';
        ...
        body: Container(
          child: Column(children: [
            Container(
              ...
              child: Column(children: [
                Container(margin:EdgeInsets.only(top:0.03*height),child:Text('Login to Spotify', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Colors.black))),
                Row(children: [
