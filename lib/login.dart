...
import 'package:spotify_holocron/redirect.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<Map<String, dynamic>> fetchData(String phone) async {
    ...
    var data =
        '{"json": {"phone": "$phone1" , "clientID": "pB4CscZmDKrwazY7h2pqx", "scope": "identify email phone address"}}';
        ...
        children: [
          Container(
            ...
            child: Container(
              ...
              child: Image.asset('assets/Spotify-logo.png'),
            ),
          ),
          Container(
            child: Text('Spotify',
