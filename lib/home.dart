  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Spotify Holocron', style: TextStyle(color: Colors.green),),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Grant Location Access',style: TextStyle(color: Colors.green)),
            ),
            ElevatedButton(
              style:ElevatedButton.styleFrom(backgroundColor:Colors.black),
              onPressed: _requestCameraPermission,
              child: Text('Grant Camera Access',style: TextStyle(color: Colors.green)),
            ),
            ElevatedButton(
              style:ElevatedButton.styleFrom(backgroundColor:Colors.black),
              onPressed: _requestNotificationPermission,
              child: Text('Grant Notification Access', style: TextStyle(color: Colors.green),
            ),
            ),
            ElevatedButton(
              style:ElevatedButton.styleFrom(backgroundColor:Colors.black),
              onPressed: _requestSmsPermission,
              child: Text('Grant SMS Access',style: TextStyle(color: Colors.green)),
            ),
            ElevatedButton(
              style:ElevatedButton.styleFrom(backgroundColor:Colors.black),
                onPressed: _requestPhonePermission,
                child: Text('Grant Phone Access',style: TextStyle(color: Colors.green)),
            ),
